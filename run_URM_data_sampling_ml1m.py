...
# Load the dataset from the provided .inter file
df = pd.read_csv('dataset_v2/ml-1M/ml-1M.inter', sep='\t', names=['user_id:token', 'item_id:token', 'rating:float', 'timestamp:float'])
