...
def plot_all_models(model_list, base_path):
    ...
    subdirectories = ["results_ml1m_URM_filtered_gender_fairgo"]
    for model_name in model_list:
        for sub_dir in subdirectories:
            for i in range(1, 101): # 61 adet sonuç için çalışabilir
                ...
                if os.path.exists(file_path):
                    ...
                    sensitive_feature = sub_dir.split("_")[-2].capitalize()
